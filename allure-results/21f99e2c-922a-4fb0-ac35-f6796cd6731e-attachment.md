...
```
Error: locator.textContent: Unsupported token "{" while parsing css selector "await page.locator('h1').filter({ hasText: 'Your Account Has Been Created!' })". Did you mean to CSS.escape it?
Call log:
  - waiting for await page.locator('h1').filter({ hasText: 'Your Account Has Been Created!' })
        ...
        - generic [ref=f1e79]:
          ...
          - generic [ref=f1e83]:
            ...
            - generic [ref=f1e111]:
              ...
              - button "Continue" [active] [ref=f1e116] [cursor=pointer]
...
```ts
  ...
  27 |     this.msgConfirmation = page.locator("await page.locator('h1').filter({ hasText: 'Your Account Has Been Created!' })");
  28 |  }
  29 | 
  30 | 
